<div>
    <div class="px-1 mb-4 d-flex align-items-center">
        <a href="{{ url('all-reviews') }}" class="btn btn-blue btn-sm" role="button">
            <i class="fa-solid fa-sm fa-list"></i>
            Danh sách bài viết
        </a>

        <a href="{{ url('add-review') }}" class="btn btn-blue btn-sm ms-1" role="button">
    ...
    <form wire:submit="update" enctype="multipart/form-data">
        ...
        <div class="row mt-2">
            ...
            <div class="col-8 col-sm-8 col-md-9 col-lg-9 col-xl-9">
                <textarea wire:model.blur="desc" rows="3" class="form-control form-control-sm"></textarea>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col offset-3 offset-sm-3 offset-md-2 offset-lg-2 offset-xl-2 d-flex">
                @if ($newImages)
                    ...
                    @endforeach
                @else
                    @forelse ($oldImages as $key => $image)
                        <img src="{{ $image->url }}" class="rounded-2 img-upload" alt="{{ $review->title }}">
        ...
        <div class="row mt-2">
            <label class="col-form-label col-3 col-sm-3 col-md-2 col-lg-2 col-xl-2 text-end">Địa điểm</label>
            <div class="col-5 col-sm-3 col-md-2">
                <select wire:model="location_id" class="form-select form-select-sm">
