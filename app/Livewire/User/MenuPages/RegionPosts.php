...
class RegionPosts extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.user.menu-pages.region-posts');
    }
    ...
    public function posts()
    {
        return Post::where('is_active', true)
            ->whereRegion($this->region)
            ->count()
            ->rangePrice()
            ->filter($this->categoryFilter, null, $this->provinceFilter, $this->districtFilter, $this->minPriceFilter, $this->maxPriceFilter, $this->starFilter)
    ...
    {
        $this->reset('categoryFilter', 'provinceFilter', 'districtFilter', 'minPriceFilter', 'maxPriceFilter', 'starFilter');
    }
}
